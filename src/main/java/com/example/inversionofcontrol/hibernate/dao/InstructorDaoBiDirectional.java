...
public class InstructorDaoBiDirectional {
    ...
    private InstructorDetailDaoBiDirectional instructorDetailDaoBiDirectional;

    //Create default constructor
    public InstructorDaoBiDirectional(){}

    public InstructorDaoBiDirectional(String firstName, String lastName, String email) {
        this.firstName = firstName;
        this.lastName = lastName;
        this.email = email;
    }

    public InstructorDaoBiDirectional(int id, String firstName, String lastName, String email, InstructorDetailDaoBiDirectional instructorDetailDaoBiDirectional) {
        this.id = id;
        this.firstName = firstName;
        this.lastName = lastName;
        this.email = email;
        this.instructorDetailDaoBiDirectional = instructorDetailDaoBiDirectional;
    }
    ...
    public InstructorDetailDaoBiDirectional getInstructorDetailDaoBiDirectional() {
        return new InstructorDetailDaoBiDirectional();
    }

    public void setInstructorDetailDaoBiDirectional(InstructorDetailDaoBiDirectional instructorDetailDaoBiDirectional) {
        this.instructorDetailDaoBiDirectional = instructorDetailDaoBiDirectional;
    }
